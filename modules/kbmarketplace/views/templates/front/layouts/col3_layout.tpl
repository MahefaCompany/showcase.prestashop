<div id="kblayout-leftcol" class="column col-xs-12 col-sm-2 pad0">
    {$HOOK_KBLEFT_COLUMN}{*Variable contains css and html content, escape not required*}
</div>
{if $TEMPLATE}
...
<div id="kblayout-rightcol" class="column col-xs-12 col-sm-2 pad0 right-col-width-fx">
    {$HOOK_KBRIGHT_COLUMN}{*Variable contains css and html content, escape not required*}
</div>
{*
* DISCLAIMER
*
