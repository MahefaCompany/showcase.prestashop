<div class="kb-content">
            ...
            <li class="summary-box green-summary">
                <div class="summary-single-box">
                    <div class="mo_kpi_content big">
                            ...
                            <span class="big-value">{convertPriceWithCurrency price=$total_paid_amount currency=$kb_seller_currency}</span>
                    </div>
                </div>
                <div class="clearfix"></div>
            </li>
            <li class="summary-box yellow-summary">
                <div class="summary-single-box">
                    <div class="mo_kpi_content big">
                            ...
                            <span class="big-value">{convertPriceWithCurrency price=$total_bal_amount currency=$kb_seller_currency}</span>
                    </div>
                </div>
                <div class="clearfix"></div>
            </li>
    ...
    {/if}
    {addJsDef transaction_view_url=$transaction_detail_url|escape:'htmlall':'UTF-8'}
