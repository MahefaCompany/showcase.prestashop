<div class="kb-content">
    <div class="kb-content-header">
        ...
        <div class="kb-content-header-btn">
            <a href="{$new_global_zone_link}" class="btn-sm btn-success" title="{l s='click to add new zone' mod='kbmarketplace'}"><i class="icon-plus"></i>{l s='Add New Zone' mod='kbmarketplace'}</a>{* Variable contains HTML/CSS/JSON, escape not required *}
        </div> 
