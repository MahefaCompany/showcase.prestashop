        ...
        <div class="kb-content-header">
            <h1>{$form_heading|escape:'htmlall':'UTF-8'}</h1>
             ...
             <div class="kbbtn-group kb-tright">
                <a href="{$cancel_button}" class="btn-sm btn-success" title="{l s='click to go back to zone list' mod='kbmarketplace'}"><i class="kb-material-icons">cancel</i>{l s='Back' mod='kbmarketplace'}</a> {* Variable contains HTML/CSS/JSON, escape not required *}
                        ...
                        <ul class="kb-form-list">
                            <li class="kb-form-fwidth">
                                ...
                                <div class="kb-form-field-block">
                                    <input type="text" class="kb-inpfield required" id="zone_name" validate="isGenericName" name="zone_name" value="{$zone_name|escape:'htmlall':'UTF-8'}"/>
                                </div>
                            </li>
                        </ul>
                    </div>
