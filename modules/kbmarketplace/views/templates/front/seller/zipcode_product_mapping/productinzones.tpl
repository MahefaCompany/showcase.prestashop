<div class="kb-content">
    <div class="kb-content-header">
        ...
        <div class="kbbtn-group kb-tright">
            ...
            <a href="{$map_products_link}" class="btn-sm btn-success" title="{l s='Click to map more Products' mod='kbmarketplace'}"><i class="icon-plus"></i>{l s='Map Products' mod='kbmarketplace'}</a>{* Variable contains HTML/CSS/JSON, escape not required *}
        </div> 
