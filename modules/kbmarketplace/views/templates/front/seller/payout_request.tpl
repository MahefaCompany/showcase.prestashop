<div class="kb-content">
    ...
    <div class="kb-block kb-form">
        ...
        {addJsDefL name=pay_amount_positive_error}{l s='Amount should be positive.' mod='kbmarketplace' js=1}{/addJsDefL}
        {addJsDefL name=pay_amount_decimal_error}{l s='Amount can have only upto two decimal values.' mod='kbmarketplace' js=1}{/addJsDefL}
        {addJsDefL name=pay_amount_valid_error}{l s='Amount Field should be numeric.' mod='kbmarketplace' js=1}{/addJsDefL}
        {addJsDefL name=pay_amount_required}{l s='Amount is required.' mod='kbmarketplace' js=1}{/addJsDefL}
            
        {addJsDefL name=pay_request_reason_min_length_error}{l s='Minimum %s characters are required for reason.' mod='kbmarketplace' sprintf=$min_reason_length js=1}{/addJsDefL}
        {addJsDefL name=pay_request_reason_required}{l s='Reason is required' mod='kbmarketplace' js=1}{/addJsDefL}
        {addJsDefL name=pay_request_reason_max_length_error}{l s='Maximum %s characters are allowed for reason.' mod='kbmarketplace' sprintf=$max_reason_length js=1}{/addJsDefL}
        {addJsDef pay_request_reason_min_length=$min_reason_length|intval}
        {addJsDef pay_request_reason_max_length=$max_reason_length|intval}
    </div>
    <div class="kb-content-header">
