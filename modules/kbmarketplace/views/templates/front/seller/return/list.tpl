...
<script>
    var kb_editor_lang = "{$editor_lang|escape:'htmlall':'UTF-8'}";
            ...
            <div id="new-return_approve-form" class="new_return_approve_form kb-form" style="padding:0;">
                <ul class="kb-form-list">
                    <li class="kb-form-fwidth">
                        ...
                        <div class="kb-form-field-block">
                            <select id="rm_change_return_status" name="rm_change_return_status" class="kb-inpselect" data-toggle="select2" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true" onclick="rmCloseModal('rm_return_history_modal')">&times;</span><span class="sr-only">{l s='Close' mod='kbmarketplace'}</span></button>
