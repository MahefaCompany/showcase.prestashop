        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="kb_gdpr_fc_rules kb-panel-box" id="kb-data-protability-panel-body">
                <ul>
                    ...
                    <li>
                        <a href="{$product_download_link|escape:'quotes':'UTF-8'}">{l s='Seller Product Listing' mod='kbmarketplace'}</a>
                    </li>
                    <li>
                        <a href="{$seller_orders_download_link|escape:'quotes':'UTF-8'}">{l s='Sellers Orders' mod='kbmarketplace'}</a>
                    </li>
                    <li>
                        <a href="{$seller_info_download_link|escape:'quotes':'UTF-8'}">{l s='Seller Information' mod='kbmarketplace'}</a>
                    </li>
                    <li>
                        <a href="{$personal_info_download_link|escape:'quotes':'UTF-8'}">{l s='Your Personal Information' mod='kbmarketplace'}</a>
                    </li>
                    <li>
                        <a href="{$address_download_link|escape:'quotes':'UTF-8'}">{l s='Addresses' mod='kbmarketplace'}</a>
                    </li>
                    <li>
                        <a href="{$orders_download_link|escape:'quotes':'UTF-8'}">{l s='Your Orders' mod='kbmarketplace'}</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="kb_gdpr_fc_rules kb-panel-box" id="kb-close-shop-panel-body">
                    <ul>
                        ...
                        <li class="kb-vspacer5"></li>
                            <form action="{$controller_link|escape:'quotes':'UTF-8'}" method="post">
