...
<div class="kb-block kb-panel">
    <div class="kb-content">
        ...
        <div class='outer-border kb-tcenter'>
            <ul class='summary-list-group'>
                <li class='summary-box blue-summary'>
                    <div class="summary-single-box">
                        <div class="mo_kpi_content big">
                                ...
                                <span class="big-value">{convertPriceWithCurrency price=$total_revenue currency=$kb_seller_currency}</span>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </li>
                <li class='summary-box purple-summary'>
                    <div class="summary-single-box">
                        <div class="mo_kpi_content big">
                                <i class="big icon-credit-card"></i>
                                <span class="big-title">{l s='Total Earning' mod='kbmarketplace'}</span>
                                <span class="big-value">{convertPriceWithCurrency price=$total_earning currency=$kb_seller_currency}</span>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </li>
        ...
        <div class="kb-panel outer-border">
            {addJsDefL name=kb_graph_revenue_label}{l s='Your Revenue' mod='kbmarketplace' js=1}{/addJsDefL}
            {addJsDefL name=kb_graph_orders_label}{l s='Total Orders' mod='kbmarketplace' js=1}{/addJsDefL}
            {addJsDefL name=kb_graph_products_label}{l s='Total Products Sold' mod='kbmarketplace' js=1}{/addJsDefL}
                            ...
                            <table class="dh-tbl-smmry">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="kb-tright">{convertPriceWithCurrency price=$report['data']['revenue']['current'] currency=$kb_seller_currency}</td>
                                        <td class="kb-tright">
                                            <div class="kb-analysis-popper">
                                                ...
                                                {/if}
                                                <div class="kb-popper-info">
                                                    <b>{$report['curent_title']|escape:'htmlall':'UTF-8'}: </b>{convertPriceWithCurrency price=$report['data']['revenue']['current'] currency=$kb_seller_currency}<br>
                                                    <b>{$report['prev_title']|escape:'htmlall':'UTF-8'}: </b>{convertPriceWithCurrency price=$report['data']['revenue']['previous'] currency=$kb_seller_currency}
                                                </div>    
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        {if count($orders) > 0}
                            {foreach $orders as $order}
                                <tr>                        
                                    ...
                                    <td class="kb-tright">{convertPriceWithCurrency price=$order['total'] currency=$kb_seller_currency}</td>
                                </tr>        
                            {/foreach}
                        {else}
