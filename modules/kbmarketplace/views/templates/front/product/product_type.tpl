<div class="kb-panel outer-border">
    ...
    <div id="kb-product-type-form" class='kb-panel-body'>
        <div class="kbalert kbalert-info">
            <i class="icon-question-sign"></i>{l s='Once the new product is saved, you cannot change the product type on edit.' mod='kbmarketplace'}
        </div>
        <div class="kb-vspacer5"></div>
        <form id="kb-product-type-selection" action="{$form_submit_url|escape:'htmlall':'UTF-8'}" method="post">
            ...
            <button type="submit" name="submitproducttype" class="kbbtn-big kbbtn-success">{l s='Next' mod='kbmarketplace'}</button>
        </form>
    </div>
</div>
{*
