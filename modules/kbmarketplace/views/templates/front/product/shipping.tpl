    ...
    <div id="kb-product-form-shipping" class='kb-panel-body'>
        <div class="kb-block kb-form">
            <ul class="kb-form-list">
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Available shipings for the product' mod='kbmarketplace'}">{l s='Available Shippings' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        ...
                        <a href="javascript:void(0)" id="addShipping" class="btn btn-default btn-block">{l s='Add' mod='kbmarketplace'} <i class="icon-arrow-right"></i></a>
                    </div>
                </li>
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Shippings that are allowed with this product' mod='kbmarketplace'}">{l s='Selected Shippings' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        ...
                        <a href="javascript:void(0)" id="removeShipping" class="btn btn-default btn-block"><i class="icon-arrow-left"></i> {l s='Remove' mod='kbmarketplace'}</a>
                    </div>
                </li>
                <li id="shipping-selection-msg" class="kb-form-fwidth" style="display:{if $product_has_shipping}none{else}block{/if};">
                    <div class="kbalert kbalert-warning"><i class="icon-exclamation-sign" style="font-size: 13px;"></i>{l s='If no shipping selected, then product will be available for sale with free shipping.' mod='kbmarketplace'}</div>
                </li>
