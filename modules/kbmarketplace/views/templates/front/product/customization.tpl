<script>
    var active_languages = {$languages_customization|json_encode};{*Variables contain JSON, can not escape this.*}
</script>
...
<div class="kb-panel outer-border kb_product_section">
    ...
    <div id="kb-product-form-customization" class='kb-panel-body'>
        ...
        {else}
            <input type="hidden" name="custom_field_last_assigned_id" id="custom_field_last_assigned_id" value="{$count_custom_field|intval}"/>
            <input type="hidden" name="default_lang_id" id="default_lang_id" value="{$default_lang|escape:'htmlall':'UTF-8'}"/>
            <div class="kb-form-field-inblock" style="float:right;margin:10px;">
                    <a href="javascript:void(0)" class="kbbtn btn-info" onclick="addCustomizationBlock();"><i class="icon-plus trash"></i><span>{l s='Add New Customization field.' mod='kbmarketplace'}</span></a>
            </div>
                        ...
                        {foreach from=$custom_field_data key=k item=data}
                            <li class="custom_field" id="component_position" style="margin: 10px;">
                                    ...
                                    <div class="kb-form-field-block">
                                        {foreach $languages_customization as $lang}
                                            {if $lang['id_lang'] == $default_lang}
                                                <input type="text" class="kb-inpfield required" validate="isGenericName" name="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_{$k|escape:'htmlall':'UTF-8'}" id="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_{$k|escape:'htmlall':'UTF-8'}" value="{$data.name[$lang['id_lang']]|escape:'htmlall':'UTF-8'}"/>
                                            {else}
                                                <input type="text" class="kb-inpfield" validate="isGenericName" name="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_{$k|escape:'htmlall':'UTF-8'}" id="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_{$k|escape:'htmlall':'UTF-8'}" style="display: none; "value="{$data.name[$lang['id_lang']]|escape:'htmlall':'UTF-8'}"/>
                                            {/if}
                                        {/foreach}
                                    </div>
                                </div>
                                <div class="" style="width: 15%;display:inline-block;margin-left: 2%;">
                                    ...
                                    <div class="kb-form-field-block">
                                        <select id="custom_field_type_{$k|escape:'htmlall':'UTF-8'}" name="custom_field_type_{$k}" class="kb-inpselect">
                                ...
                                <div class="" style="width: 11%;display:inline-block;margin-left: 2%;">
                                    <a href="javascript:void(0)" class="kbbtn btn-info" onclick="trashCustomfield(this);"><i class='icon-trash' style='padding-right:5px'></i><span>{l s='Delete' mod='kbmarketplace'}</span></a>
                                </div>
                                <div class="" style="width: 8%;display:inline-block;margin-left: 2%">
                                    ...
                                    <div class="kb-form-field-block">
                                        <select id="custom_fields_require_{$k|escape:'htmlall':'UTF-8'}" name="custom_fields_require_{$k}" class="kb-inpselect">
                ...
                <li class="custom_field" id="component_position" style="margin: 10px;">
                    <div class="" style="vertical-align: top;width: 23%;display:inline-block;">
                        ...
                        <div class="kb-form-field-block">
                            {foreach $languages_customization as $lang}
                                {if $lang['id_lang'] == $default_lang}
                                    <input type="text" class="kb-inpfield" validate="isGenericName" name="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_id" id="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_id" value=""/>
                                {else}
                                    <input type="text" class="kb-inpfield" validate="isGenericName" name="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_id" id="custom_field_name_lang_{$lang['id_lang']|escape:'htmlall':'UTF-8'}_id" style="display: none; "value=""/>
                                {/if}
                            {/foreach}
                        </div>
                    </div>
...
<script type="text/javascript">
    var default_lang_id = {$default_lang|escape:'htmlall':'UTF-8'};
