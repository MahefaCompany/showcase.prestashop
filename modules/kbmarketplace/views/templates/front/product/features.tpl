    ...
    <div id="kb-product-form-features" class='kb-panel-body'>
        {if $id_product eq 0}
            <div class="kbalert kbalert-warning pack-empty-warning">
                <i class="icon-exclamation-sign" style="font-size:12px; margin-right:5px;"></i> {l s='Please save this product, before adding feature(s).' mod='kbmarketplace'}
            </div>
        {else}
           <div class="kb-block kb-form">
            ...
            <ul class="kb-form-list">
                ...
                <li class="kb-form-r">
                    ...
                    <div class="kb-form-field-block">
                        <input type="text" class="kb-inpfield" id="kb-product-{$feature['id_feature']|intval}-feature" name="feature_{$feature['id_feature']|intval}_cvalue" value="{if isset($product_features[$feature['id_feature']])}{$product_features[$feature['id_feature']]|escape:'htmlall':'UTF-8'}{/if}">
                    </div>
                </li>
                {/if}
                {* changes over *}
