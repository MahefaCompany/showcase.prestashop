...
<div class="kb-panel outer-border kb_product_section">
            ...
            <ul class="kb-form-list">
                <li class="kb-form-fwidth">
                    <div class="kb-form-label-inblock">
                        <span class="kblabel "><i class="icon-question" data-toggle="tooltip" data-placement="top" data-original-title="{l s='Start by typing the first letters of the product name, then select the product from the drop-down list.' mod='kbmarketplace'}"></i>{l s='Add Product in your Pack' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-inblock pakcage_pro_search">
                        ...
                        <div class="kb-form-field-inblock package_pro_add_btn">
                            <a id="add_pack_item" href="javascript:void(0)" class="kbbtn btn-warning"  style="height:28px; padding-top: 6px;"><i class="icon-plus"><span>{l s='Add' mod='kbmarketplace'}</span></i></a>
                        </div>
                    </div>
                </li>
                    ...
                    <ul id="divPackItems" class="list-unstyled">
                        {foreach $pack_items as $pack_item}
                            <li class="product-pack-item packpro-prev-pack" data-product-name="{if isset($curPackItemName)}{$curPackItemName|escape:'htmlall':'UTF-8'}{/if}" data-product-qty="{$pack_item.pack_quantity|intval}" data-product-id="{$pack_item.id|intval}">
                                ...
                                <button type="button" class="btn btn-default delPackItem packpro-prev-pack-action" data-delete="{$pack_item.id|intval}" ><i class="icon-trash"></i></button>
                            </li>
                        {/foreach}
                    </ul>
                    <div class="clearfix"></div>
    ...
    {addJsDefL name=kb_package_product_ref_lbl}{l s='REF' mod='kbmarketplace' js=1}{/addJsDefL}
