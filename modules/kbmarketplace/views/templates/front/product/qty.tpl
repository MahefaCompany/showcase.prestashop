            ...
            <ul class="kb-form-list">
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Quantity of the product' mod='kbmarketplace'}">{l s='Quantity' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        <input type="text" class="kb-inpfield {if $has_attributes > 0}disabled{/if}" validate="isInt" name="qty_0" value="{if $qty > 0} {$qty|escape:'htmlall':'UTF-8'} {else}0{/if}" {if $has_attributes > 0}readonly="true"{/if}/>
                    </div>
                </li>
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel "><i class="icon-question" data-toggle="tooltip" data-placement="top" data-original-title="{l s='Action when product is out of stock' mod='kbmarketplace'}"></i>{l s='Out of Stock' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel "><i class="icon-question" data-toggle="tooltip" data-placement="top" data-original-title="{l s='The minimum quantity to buy this product (set to 1 to disable this feature)' mod='kbmarketplace'}"></i>{l s='Minimum Quantity' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        <input type="text" class="kb-inpfield" name="minimal_quantity" validate="isInt" maxlength="6" value="{$minimal_quantity|escape:'htmlall':'UTF-8'}" />
                    </div>
                </li>
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Text to display when the product is in-stock' mod='kbmarketplace'}">{l s='Displayed text when in-stock' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
