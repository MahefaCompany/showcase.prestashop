            ...
            <ul class="kb-form-list">
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Name of the product' mod='kbmarketplace'}">{l s='Name' mod='kbmarketplace'}</span><em>*</em>
                    </div>
...
{*                        <input type="text" class="kb-inpfield required" validate="isGenericName" name="name_{$default_lang|intval}" lang-id="{$default_lang|intval}" value="{$name|escape:'htmlall':'UTF-8'}" onkeyup="updateLinkRewrite(this)" />*}
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Reference code of the product' mod='kbmarketplace'}">{l s='Reference Code' mod='kbmarketplace'}</span><em>*</em>
                    </div>
                    <div class="kb-form-field-block">
                        <input maxlength="32" type="text" class="kb-inpfield required" validate="isGenericName" name="reference" value="{$reference|escape:'htmlall':'UTF-8'}" />
                    </div>
                </li>
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Enter Ean-13 or JAN barcodes for your product' mod='kbmarketplace'}">{l s='EAN-13 or JAN barcode' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Enter UPC barcode for your product' mod='kbmarketplace'}">{l s='UPC barcode' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Enable/Disable the products on front' mod='kbmarketplace'}">{l s='Active' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Select visibility scope of the product' mod='kbmarketplace'}">{l s='Visibility' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Condition of the product' mod='kbmarketplace'}">{l s='Condition' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Manufacturer of the product' mod='kbmarketplace'}">{l s='Manufacturer' mod='kbmarketplace'}</span>
                        {if $is_enable_custom_manufacturer_addition}
                        <div class="kb-form-field-inblock" style="float:right;padding:2px;">
                                <a href="javascript:void(0)" class="kbbtn btn-info" onclick="addNewManufacturer();"><i class="icon-plus trash"></i><span>{l s='Add New Manufacturer' mod='kbmarketplace'}</span></a>
                        </div>
                    {/if}
                    </div>
                ...
                <li class="kb-form-fwidth">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Product options to set on front' mod='kbmarketplace'}">{l s='Options' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-fwidth">
                    <div class="kb-form-label-block">
                        <span class="kblabel "title="{l s='Short description of the product' mod='kbmarketplace'}">{l s='Short Description' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        {foreach $languages as $language}                            
                            <textarea {if $default_lang == $language['id_lang']}style="display:block;"{else}style="display:none;"{/if} name="description_short_{$language['id_lang']|intval}" rows="5" class="kb-inptexarea autoload_rte">{$description_short[$language['id_lang']]}</textarea> {* Variable contains HTML/CSS/JSON, escape not required *}
                        {/foreach}
                        {*<textarea name="description_short_{$default_lang|intval}" rows="5" class="kb-inptexarea autoload_rte">{$description_short}</textarea>{*Variable contains css and html content, escape not required*}
                        <span class="counter" data-max="{if $short_description_limit}{$short_description_limit|intval}{else}none{/if}"></span>
                    </div>
                </li>
                <li class="kb-form-fwidth">
                    <div class="kb-form-label-block">
                        <span class="kblabel "title="{l s='Full description of the product' mod='kbmarketplace'}">{l s='Description' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        {foreach $languages as $language}                                                        
                            <textarea {if $default_lang == $language['id_lang']}style="display:block;"{else}style="display:none;"{/if} name="description_{$language['id_lang']|intval}" rows="5" class="kb-inptexarea autoload_rte">{$description[$language['id_lang']]}</textarea> {* Variable contains HTML/CSS/JSON, escape not required *}
                        {/foreach}                        
{*                        <textarea name="description_{$default_lang|intval}" rows="5" class="kb-inptexarea autoload_rte">{$description}</textarea>{*Variable contains css and html content, escape not required*}
                    </div>
                </li>
                <li class="kb-form-fwidth last-row">
                    <div class="kb-form-label-block">
                        <span class="kblabel " title="{l s='Tags by which the product can be searched' mod='kbmarketplace'}">{l s='Tags' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
