            ...
            <div class="col-lg-6">
                    <div class="panel">
                        ...
                        {if $seller_info['description'] != ''}
                            <p>
                                {$seller_info['description']}{*Variable contains css and html content, escape not required*}
                            </p>
                        {else}
            ...
            <div class="col-lg-6">
                    ...
                    <div class="panel">
                            ...
                            {if $seller_info['privacy_policy'] != ''}
                                <p>
                                        {$seller_info['privacy_policy']}{*Variable contains css and html content, escape not required*}
                                </p>
                            {else}
                                <p class="text-muted text-center">
                    ...
                    <div class="panel">
                            ...
                            {if $seller_info['shipping_policy'] != ''}
                                <p>
                                        {$seller_info['shipping_policy']}{*Variable contains css and html content, escape not required*}
                                </p>
                            {else}
                                <p class="text-muted text-center">
                    ...
                    <div class="panel">
                            ...
                            {if $seller_info['return_policy'] != ''}
                                <p>
                                        {$seller_info['return_policy']}{*Variable contains css and html content, escape not required*}
                                </p>
                            {else}
                                <p class="text-muted text-center">
                            ...
                            {if count($payment_info) > 0 && $payment_info != ''}
                                    {foreach $payment_info['data'] as $data}
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <pre>{$data['value']|escape:'htmlall':'UTF-8'}</pre>
                                                    </div>
                                            </div>
                                    {/foreach}
