...
('f', 'mp_seller_account_approval', 'This template is used to notify the customer/seller about the approval of the seller account.', NOW(), NOW()),
...
('kbmarketplace', 'dashboard', 1, 'dashboard', NULL, 0, NULL, NOW(), NOW()),
('kbmarketplace', 'seller', 2, 'pencil', NULL, 0, NULL, NOW(), NOW()),
('kbmarketplace', 'kbproduct', 3, 'list', NULL, 1, 'KbSellerProduct', NOW(), NOW()),
('kbmarketplace', 'order', 4, 'shopping-cart', NULL, 1, 'KbSellerEarning', NOW(), NOW()),
('kbmarketplace', 'productreview', 5, 'list', NULL, 1, 'KbSellerProductReview', NOW(), NOW()),
('kbmarketplace', 'sellerreview', 6, 'heart', NULL, 1, 'KbSellerReview', NOW(), NOW()),
('kbmarketplace', 'earning', 7, 'money', NULL, 0, NULL, NOW(), NOW()),
('kbmarketplace', 'transaction', 8, 'credit-card', NULL, 0, NULL, NOW(), NOW()),
('kbmarketplace', 'payoutrequest', 9, 'exchange', NULL, 0, NULL, NOW(), NOW()),
('kbmarketplace', 'category', 10, 'tags', NULL, 1, 'KbSellerCRequest', NOW(), NOW()),
('kbmarketplace', 'shipping', 11, 'truck', NULL, 1, 'KbSellerShipping', NOW(), NOW());
