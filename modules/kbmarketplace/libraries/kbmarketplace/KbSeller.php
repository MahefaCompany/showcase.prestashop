...
class KbSeller extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            /*Start- MK made changes on 31-05-18 for the privacy policy*/
            'privacy_policy' => array(
                'type' => self::TYPE_HTML,
                'lang' => true,
                'validate' => 'isCleanHtml',
            )
            /*End- MK made changes on 31-05-18 for the privacy policy*/
        ),
        'associations' => array(
            'customer' => array('type' => self::HAS_ONE, 'field' => 'id_customer',
                'object' => 'Customer'),
            'language' => array('type' => self::HAS_ONE, 'field' => 'id_default_lang',
                'object' => 'Language'),
            'shop' => array('type' => self::HAS_ONE, 'field' => 'id_seller_shop',
                'object' => 'Shop'),
            'kbsellerproducts' => array('type' => self::HAS_MANY, 'field' => 'id_seller',
                'object' => 'KbSellerProduct', 'association' => 'kb_mp_seller_product'),
            'kbsellercategories' => array('type' => self::HAS_MANY, 'field' => 'id_seller_category',
                'object' => 'KbSellerCategory', 'association' => 'kb_mp_seller_category'),
        )
    );
    protected $webserviceParameters = array(
        ...
        'associations' => array(
            ...
            'kbsellercrequests' => array('getter' => 'getRequestedCategoriesWs',
                'resource' => 'kbsellercrequest'),
            'categories' => array(
    ...
    $only_count = false, $include_review_count = true, $start = null, $limit = null, $orderby
    = null, $orderway = null, $approved = false, $active = false, $id_lang = null, $id_shop
    = null
    )
    {
    ...
    public function registerNewCustomer($id_customer = 0, $approve = KbGlobal::APPROVED, $active
    = KbGlobal::DISABLE)
    {
