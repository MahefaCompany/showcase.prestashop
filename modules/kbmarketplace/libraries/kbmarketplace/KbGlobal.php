...
class KbGlobal extends ObjectModel
{
    ...
    public static function getDefaultSettings($key = null)
    {
        ...
        $seller_order_email_template_default = "<table>
											<tbody>
											<tr>
											<td colspan='5' align='center' class='titleblock' style='padding: 7px 0;'><span size='2' face='Open-sans, sans-serif' color='#555454' style='color: #555454; font-family: Open-sans, sans-serif; font-size: small;'> <span class='title' style='font-weight: 500; font-size: 28px; text-transform: uppercase; line-height: 33px;'>Hi {seller_name},</span><br /> <span class='subtitle' style='font-weight: 500; font-size: 16px; text-transform: uppercase; line-height: 25px;'> A Customer has just placed an order for your products on {shop_name}!</span> </span></td>
											</tr>
											<tr>
											<td colspan='5' class='space_footer' style='padding: 0!important;'> </td>
											</tr>
											<tr>
											<td colspan='5' class='box' style='border: 1px solid #D6D4D4; background-color: #f8f8f8; padding: 7px 14px;'>
											...
											<tbody>
											<tr>
											<td colspan='5' style='border: 1px solid #D6D4D4; background-color: #f8f8f8; padding: 7px 14px;'>
         ...
         *  to add email template for order cancellation
         */
        $seller_order_cancel_email_template_default = "<table>
											<tbody>
											<tr>
											<td colspan='5' align='center' class='titleblock' style='padding: 7px 0;'><span size='2' face='Open-sans, sans-serif' color='#555454' style='color: #555454; font-family: Open-sans, sans-serif; font-size: small;'> <span class='title' style='font-weight: 500; font-size: 28px; text-transform: uppercase; line-height: 33px;'>Hi {seller_name},</span><br /> <span class='subtitle' style='font-weight: 500; font-size: 16px; text-transform: uppercase; line-height: 25px;'> A Customer has just cancelled an order for your products on {shop_name}!</span> </span></td>
											</tr>
											<tr>
											<td colspan='5' class='space_footer' style='padding: 0!important;'> </td>
											</tr>
    ...
    public static function getDefaultSettingsFirstTime($key = null)
    {
        ...
        $seller_order_email_template_default = "0";
    ...
    public static function getSellerMenus()
    {
        return array(
            ...
            array('label' => 'Payout Request', 'title' => 'Payout Request', 'module' => 'kbmarketplace',
                'controller' => 'payoutrequest', 'icon_class' => 'exchange'),
    ...
    public static function getPaging($total, $start, $limit, $include_pagin_summary
    = false, $callback = '')
    {
        ...
        return array(
            ...
            'pagination' => self::generatePaginator(
                    $start, $limit, $total, $total_pages, $callback, $include_pagin_summary
            )
        );
    }
    ...
    $start, $limit, $total_records, $total_pages, $ajaxcallfn = '', $show_total = true
    )
    {
        $summary_txt = '';
        $pagination  = '';
    ...
    public static function getCategories()
    {
        ...
        foreach ($tmp as $c) {
            ...
            if (isset($c['children']) && is_array($c['children']) && count($c['children'])
                    > 0) {
    ...
    $category_w_parents_array = array(), $id_lang = null, $include_home = false
    )
    {
    ...
    public static function getBaseLink($ssl = null, $id_shop = null)
    {
        ...
        $base = (($ssl && Configuration::get('PS_SSL_ENABLED')) ? 'https://'.$shop->domain_ssl
                            : 'http://'.$shop->domain);

        return $base.$shop->getBaseURI();
    }

    public static function getSellerLink($seller, $alias = null, $id_lang = null, $id_shop
    = null, $force_routes = false)
    {
        ...
        if (!(bool) Configuration::get('PS_REWRITING_SETTINGS')) {
            ...
            return $context->link->getModuleLink(
                            'kbmarketplace', 'sellerfront', array('render_type' => 'sellerview',
                        'id_seller' => $id)
            );
        }
