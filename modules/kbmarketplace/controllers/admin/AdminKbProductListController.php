...
class AdminKbProductListController extends AdminKbMarketplaceCoreController
{
    public function __construct()
    {
        ...
        $this->_select .= 'shop.name as shopname,a.id_product as seller_id_prod, cus.`firstname`, cus.`lastname`,';
        ...
        $this->fields_list['seller_id_prod'] = array(
    ...
    public function processStatus()
    {
        ...
        if (!$seller->isApprovedSeller() || $seller->active == 0) {
            $this->context->cookie->__set(
                'kb_redirect_error',
                $this->module->l('You can\'t change the status as seller of this product is not active.', 'adminkbproductlistcontroller')
            );
        } else {
