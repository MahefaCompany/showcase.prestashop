...
class AdminKbEmailController extends AdminKbMarketplaceCoreController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        /* Start - Code Modified by RS on 25-Aug-2017 for fixing 'Blank Subject Email Templates Subject (Email Templates Listing in the admin panel)' issue */
        $this->lang  = true;
        /* End - Code Modified by RS on 25-Aug-2017 for fixing 'Blank Subject Email Templates Subject (Email Templates Listing in the admin panel)' issue */
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                array(
                    ...
                    'col' => '9',
                    'class' => 'col-lg-9',
                    'hint' => $this->module->l('Invalid characters:', 'adminkbemailcontroller').' 0-9!&lt;&gt;,;?=+()@#"°{}_$%:'
                ),
                array(
                    'type' => 'textarea',
