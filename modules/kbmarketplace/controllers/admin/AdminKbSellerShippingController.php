...
//        $this->bulk_actions = array();
    ...
    public function renderView()
    {
        ...
        if (!Validate::isLoadedObject($object)) {
            ...
            foreach ($taxas as $t) {
                if ($t['id_tax'] == $object->id_tax_rules_group) {
                    $tax_string = $t['name'];
                    break;
                }
            }

            $billing_string = $this->module->l('[undefined]', 'adminkbsellershippingcontroller');
    ...
    public function getPaymentMethodname($name)
    {
        $payment_methods = array(
            ...
            'check' => $this->module->l('Payment by Cheque', 'adminkbsellershippingcontroller'),
