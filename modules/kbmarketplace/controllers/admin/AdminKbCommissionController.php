...
class AdminKbCommissionController extends AdminKbMarketplaceCoreController
{
    ...
    {
        $this->bootstrap = true;
        if (Tools::getIsset('commsion_view_type') && Tools::getValue('commsion_view_type')
            == 1) {
        ...
        if (Tools::getIsset('commsion_view_type') && Tools::getValue('commsion_view_type')
            ...
            // commented by rishabh jain
            $this->_where .= ' AND a.is_canceled = "0"';
            if (Tools::getIsset('commsion_by_category') && (int) Tools::getValue('commsion_by_category')
                > 0) {
