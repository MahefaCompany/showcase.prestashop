...
class KbmarketplaceProductreviewModuleFrontController extends KbmarketplaceCoreModuleFrontController
{
    ...
    private function renderList()
    {
        ...
        if (Module::isInstalled('productcomments')) {
            $approve_statuses = array(
                array('value' => 0, 'label' => $this->module->l('Waiting for Approval', 'productreview')),
                array('value' => 1, 'label' => $this->module->l('Approved', 'productreview'))
            );
            ...
            $this->table_header = array(
                ...
                array('label' => $this->module->l('Posted On', 'productreview'), 'width' => '80'),
                array('label' => $this->module->l('Product Name', 'productreview'), 'width' => '150'),
                array('label' => $this->module->l('Status', 'productreview'), 'width' => '150'),
                array('label' => $this->module->l('Comment', 'productreview')),
                array('label' => $this->module->l('Rating', 'productreview'), 'width' => '80')
            );
    ...
    public function processMultiAction()
    {
        $all_updated  = true;
        $update_count = 0;
        if (Tools::getIsset('mutiaction_type') && Tools::getValue('mutiaction_type')
