    ...
    private function renderList()
    {
        ...
        if ($this->total_records > 0) {
            ...
            foreach ($reviews as $review) {
                ...
                $rating_block = '<div class="vss_seller_ratings"><div
                    class="vss_rating_unfilled">★★★★★</div>
                    <div class="vss_rating_filled"
                    style="width:'.$rating_percent.'%">★★★★★</div></div>';
                ...
                $this->table_content[$review['id_seller_review']] = array(
                    ...
                    array('value' => $this->clipLongText($review['comment'], $read_more_link)),
                    ...
                    .$review['id_seller_review'].')">#'.$review['id_seller_review'].'</a>
                        ...
                        <td>'.Tools::displayDate($review['date_add'], null, true).'</td>
                            <td>'.$review['firstname'].' '.$review['lastname'].'</td>
                                ...
                                <td>'
                    .$this->clipLongText(Tools::safeOutput($review['comment']), $read_more_link)
                    .'</td><td>'.$rating_block.'</td></tr>';
            }
