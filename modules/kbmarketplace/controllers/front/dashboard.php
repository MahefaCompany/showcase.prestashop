...
class KbmarketplaceDashboardModuleFrontController extends KbmarketplaceCoreModuleFrontController
{
    ...
    {
        $total_revenue = KbSellerEarning::getTotalEarningInSellerOrders($this->seller_info['id_seller']);
    ...
    protected function getGraphData()
    {
        ...
        $set = array(
            'total_revenue' => (int) 0,
            'seller_revenue' => (int) 0,
            'admin_revenue' => (int) 0,
            'ordered_qty' => (int) 0,
            'total_order' => (int) 0,
            'formatted_total_revenue' => pSQL('NA'),
            'formatted_seller_revenue' => pSQL('NA'),
            'formatted_admin_revenue' => pSQL('NA')
        );
        $stats   = array();
