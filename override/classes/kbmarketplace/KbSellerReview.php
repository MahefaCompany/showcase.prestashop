...
class KbSellerReview extends ObjectModel
{
    ...
    $id_seller, $id_lang = null, $approved_status = false, $only_count = false, $rating
    = false, $start = null, $limit = null, $filter_string = null
    )
    {
        ...
        if ($only_count) {
            ...
            $col_string = 'sr.*, ((sr.rating/'.KbGlobal::MAX_RATING.')*100) as rating_percent, 
				c.firstname, c.lastname,c.id_customer ';
